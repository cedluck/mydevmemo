<?php
	function RegEx($texte)
	{
		...
		//mot clé hmtl
		$texte = preg_replace('#(.*)(content|media|rel|charset|href|title|target|src|class|alt|method|action|for|type|name|placeholder|id|size|maxlength|value|label|cols|rows|selected|checked)(=)(&quot;.*&quot;)#isU', '$1<span style="color:#45ce55">$2</span><span style="color:black">$3</span><span style="color:#E6DB74">$4</span>', $texte);
		//attribut
		...
		$texte= preg_replace('#(.*)(for[^each]\s|while|switch|case|break|else|if\(|elseif|default|new|try|catch|die|->|=>|::|SELECT|FROM|WHERE|DESC|LIMIT|AND|INSERT INTO|VALUES|UPDATE|DELETE|SET)(.*)#sU', '$1<span style="color:#F92672">$2</span>$3', $texte);
		//commentaires html
